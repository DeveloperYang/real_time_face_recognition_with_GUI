...
class facenetEmbedding:
    ...
    def get_embedding(self,images):
        ...
        return embedding
    def compare_embadding(self, pred_emb, dataset_emb, names_list, threshold=0.7):
        # 为bounding_box 匹配标签
        ...
        for i in range(pred_num):
            ...
            if (min_value > threshold):
                ...
                face_to_show_name.append(names_list[dist_list.index(min_value)])
        return pred_name, pred_score, face_to_show_name
