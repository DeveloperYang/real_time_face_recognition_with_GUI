...
################################ Create by xy 2019/12/8 Begin ####################################
def save_rgb_image(title, image, type='rgb'):
    '''
    调用OpenCV显示RGB图片
    :param title: 图像标题
    :param image: 输入RGB图像
...
if __name__=="__main__":
    image_path="../dataset/test_images/com.jpg"
